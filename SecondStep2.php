...
<div class="container">
	...
	<h2 class="acc_trigger"><a href="#">아이폰(iPhone)에서 공중파를 시청할 수 있는 방법?</a></h2>
	...
	<h2 class="acc_trigger"><a href="#">iPhone분실시 기본어플인 나의 iPhone찾기 기능 활용하기! </a></h2>
	...
	<h2 class="acc_trigger"><a href="#"> 기본 날씨 앱에 다른 도시 추가하기! </a></h2>
	<div class="acc_container">
		<div class="block">
	...
	<h2 class="acc_trigger"><a href="#">나의 아이폰(iPhone)! 리퍼폰인지 아닌지 확인할 수 있을까? </a></h2>
	<div class="acc_container">
		<div class="block">
	...
	<h2 class="acc_trigger"><a href="#">아이폰(iPhone)에서 한자를 입력하는 방법은? </a></h2>
	<div class="acc_container">
		<div class="block">
	...
	<h2 class="acc_trigger"><a href="#">내 아이폰(iPhone)에서 작성한 메모를 나의 메일로 옮겨보자! </a></h2>
	<div class="acc_container">
		<div class="block">
	...
	<h2 class="acc_trigger"><a href="#">잠금상태에서 아이폰(iPhone)의 아이팟 노래 바꾸기! </a></h2>
	<div class="acc_container">
		<div class="block">
	...
	<h2 class="acc_trigger"><a href="#">아이폰(iPhone) 앱 용량 효과적으로 관리하기! </a></h2>
	<div class="acc_container">
		<div class="block">
	...
	<div class="prev_num">
	<a href="SecondStep.php"><img src="img/prev.png" /></a>
	</div>
