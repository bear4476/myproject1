...
<?php
   ...
   $num = $_GET['num'];
   $page = $_GET['page'];
   $query = "select * from newsboard where board_id = $num";
   ...
   $query1 = "update newsboard set hit=$hit where board_id=$num";
...
<?php
    $query = "select * from free_ripple2 where parent=$num order by regist_day";
    $result = mysqli_query($dbc,$query);
...
<?php
      echo '<form method="post" action="insert_fripple2.php?num='.$num.'">
...
<?php
   if ($_SESSION['username']=="admin")
   {
      echo '<tr>
          <td align="center">
          <a href="modify_form2.php?num='.$num.'&amp;page='.$page.'"><img src="img/modify.png" border="0">&nbsp</a>
          <a href="delete2.php?num='.$num.'&amp;page='.$page.'"><img src="img/del.png" border="0">&nbsp</a>
          <a href="newsboard.php?page='.$page.'"><img src="img/list.png" border="0"></a>
          </td>
        </tr>';
   }else{
      echo '<tr>
